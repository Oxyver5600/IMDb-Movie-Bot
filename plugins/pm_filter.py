...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/Oxyver_hindi_movies"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/B4U_movies_in_hindi")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/Oxyver_Support'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/Oxyver_hindi_movies')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/B4U_movies_in_hindi')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/B4U_movies_in_hindi')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Adult Channel 🔞', url='https://t.me/adult_18_plus_movies')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/Oxyver_Support_Channel/59'),
            InlineKeyboardButton('Source 🪤', url='https://t.me/Oxyver_Owner')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/B4U_movies_in_hindi")
    ])
