...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/Oxyver_Support_Channel')
            ],
            [
    ...
    buttons = [
        [
            InlineKeyboardButton('⭕️ Support Group', url='https://t.me/Oxyver_Support'),
            InlineKeyboardButton('Movie Channel ⭕️', url='https://t.me/Oxyver_hindi_movies')
        ],
        [
            InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/Oxyver_hindi_movies')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
